...
public class FileSystemWorker {
	...
	public File[] getFilesFromPrefix(String directory, final String prefix) {
		...
		try {
			...
			File[] fileCandidates = filePath.listFiles(new FileFilter() { // find files that have the intruder path
																			// prefix
	...
	public static boolean createOutputFile(String path, String file_contents) {

		File file = new File(path);
		return createOutputFile(file, file_contents);
	}

	public static boolean createOutputFile(String path, String file_contents, CompressionFormat format) {

		File file = new File(path);
		return createOutputFile(file, file_contents, format);
	}

	public static boolean createOutputFile(File file, String file_contents) {
	...
	public static boolean createOutputFile(File file, String file_contents, CompressionFormat format) {
